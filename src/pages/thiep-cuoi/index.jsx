    ...
    return (
        <>
            <Head>
                ...
                <meta
                    name="description"
                    content="Trân trọng kính mời bạn đến dự lễ thành hôn của Gia Phú & Kim Chi ngày 06/12/2025."
                />
                <meta
                    property="og:title"
                    content="Thiệp cưới Gia Phú & Kim Chi"
                />
                <meta
                    property="og:description"
                    content="Trân trọng kính mời bạn đến dự lễ thành hôn của Gia Phú & Kim Chi ngày 06/12/2025."
                />
                <meta property="og:image" content="/assets/images/self-1.jpg" />
                <meta
                    property="og:url"
                    content="https://mcgiaphu.com/thiep-cuoi"
                />
            ...
            >
                        ...
                        <div className="relative z-10 mx-auto flex h-full max-w-4xl flex-col items-center justify-end px-4 pb-16 text-center">
                            ...
                            >
                                ...
                                <blockquote className="mt-2 text-sm italic opacity-80">
                                    &quot;Nơi tình yêu bắt đầu, hành trình hạnh
                                    phúc mở ra.&quot;
                                </blockquote>
                            </div>
                        </div>
                    ...
                    <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
                        ...
                        <section className="pb-12 text-center">
                            ...
                            <p className="font-poppins mt-4 text-base italic opacity-90">
                                Chúng tôi trân trọng kính mời quý vị và gia đình
                                đến chung vui cùng chúng tôi trong ngày hạnh
                                phúc.
                            </p>
                ...
                >
                    ...
                    <p className="font-poppins text-sm opacity-80">
                        Sự hiện diện của Quý vị là niềm vinh hạnh lớn lao cho
                        gia đình chúng tôi.
                    </p>
